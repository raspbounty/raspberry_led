...
class LedMatrix:
    ...
    def __init__(self, iconset=1):
        if iconset == 0:
            ...
            thunderstormIds = [25, 24, 33, 42, 43, 44, 36, 47, 38, 37, 28, 29,
                               52, 35, 34, 51, 32, 41, 20, 26, 17, 16]
            smallCloudIds = [61, 60, 59, 54, 46, 38, 30, 27, 42, 50, 34, 19, 12, 13, 22]
            smallSunIds = [11, 10, 18, 4, 1, 25, 32]
        ...
        self.icons = {'scattered_cloud': [[Color(255, 255, 255), cloudIds]],
                      ...
                      'broken_clouds': [[Color(255, 255, 255), smallWhiteCloudIds],
